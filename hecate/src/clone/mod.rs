...
pub fn get(conn: r2d2::PooledConnection<r2d2_postgres::PostgresConnectionManager<postgres::Client>>) -> Result<PGStream, HecateError> {
...
pub fn query(read_conn: r2d2::PooledConnection<r2d2_postgres::PostgresConnectionManager<postgres::Client>>, query: &str, limit: &Option<i64>) -> Result<PGStream, HecateError> {
