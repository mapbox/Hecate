        ...
        <WFS_Capabilities version="2.0.0" schemaLocation="http://www.opengis.net/wfs/2.0 http://ggcity.org:80/geoserver/schemas/wfs/2.0/wfs.xsd" updateSequence="4682">
            ...
            <OperationsMetadata>
                <Operation name="GetCapabilities">
                    <DCP><HTTP>
                            <Get href="https://services.nationalmap.gov/arcgis/services/WFS/govunits/MapServer/WFSServer?"/>
                            <Post href="https://services.nationalmap.gov/arcgis/services/WFS/govunits/MapServer/WFSServer"/>
                    </HTTP></DCP>
            ...
            <FeatureTypeList>
                <FeatureType>
                    <Name>WFS_govunits:Reserve</Name>
                    <Title>Reserve</Title>
                    <DefaultCRS>urn:ogc:def:crs:EPSG::4326</DefaultCRS>
                    <WGS84BoundingBox>
                        <LowerCorner>-179.1500822837491 -14.55975325902829</LowerCorner>
                        <UpperCorner>179.7751119061824 71.21464378528709</UpperCorner>
                    </WGS84BoundingBox>
                </FeatureType>
            </FeatureTypeList>
            <Filter_Capabilities>
